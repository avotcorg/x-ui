...
acme() {
   wget -N https://raw.githubusercontents.com/avotcorg/acme-script/master/acme.sh && chmod +x acme.sh && ./acme.sh
    echo ""
    before_show_menu
}

bbr() {
bash <(curl -L -s https://raw.githubusercontents.com/avotcorg/bbr/master/bbr.sh)
    echo ""
    before_show_menu
}
